...
import 'package:we_chat/models/UserModel.dart';
import 'package:we_chat/screens/group_chat.dart';
        ...
        child: Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
                ...
                onPressed: () {
                   Navigator.push(context, MaterialPageRoute(builder: (_) => GroupChatPage()));
      ...
      builder: (_) {
        return AlertDialog(
          ...
          content: SizedBox(
            ...
            height: 300, // Set a height to prevent overflow
            child: FutureBuilder<List<UserModel>>(
              future: APIs.getAllUsersExceptCurrent(),
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return const Center(child: CircularProgressIndicator());
                }
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return ListTile(
                            ...
                            onTap: () async {
                              ...
                              final added = await APIs.addChatUser(user.email);
